    ...
    return (
        <div className={`min-h-screen w-full transition-all duration-[3000ms] ease-in-out relative overflow-hidden ${theme.gradient}`}>
            ...
            <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                <svg viewBox="0 0 100 100" className="absolute -top-10 -left-10 w-80 h-80 opacity-60 transition-colors duration-[3000ms]">
                    <path
                ...
                <svg viewBox="0 0 100 100" className="absolute bottom-[-10%] right-[-10%] w-96 h-96 opacity-50 transition-colors duration-[3000ms]">
                    <path
                        className={`${theme.blob2} animate-glow animate-reverse`}
