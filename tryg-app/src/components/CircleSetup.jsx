...
export const CircleSetup = ({ userRole, userName, onCreateCircle, onJoinCircle, loading, error }) => {
    const [inviteCode, setInviteCode] = useState('');
    const [createdCode, setCreatedCode] = useState(null);
    const [copied, setCopied] = useState(false);
    const [step, setStep] = useState('initial'); // 'initial', 'creating', 'created', 'joining'
