                        ...
                        <div className="h-full overflow-y-auto">
                            ...
                            {isSenior ? (
                                <SeniorView
                                    ...
                                    onSymptomLog={handleAddSymptom}
                                    weeklyAnswers={weeklyAnswers}
                                    onWeeklyAnswer={handleWeeklyAnswer}
                                    onToggleLike={onToggleLike}
                                    onReply={onReply}
                                    // matchRequests not available in props?
                                    // memberStatuses={memberStatuses}
                                    // Using props from defined interface
                                    memberStatuses={memberStatuses}
                                    currentUserId={user?.uid}
                                    onPing={(type) => handleSendPing(seniorName, 'relative')}
                                    pings={[]} // TODO: wire up pings list if needed
                                    activeMatch={null} // TODO: wire up match logic
                                    onMatchDismiss={() => { }} // TODO: wire up
